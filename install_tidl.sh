...
# TODO Fix to a specifc revision?
...
printf "now run :-\ncd /opt/ti/edgeai-tidl-tools; source ./setup.sh\n\n"
...
# wget  https://software-dl.ti.com/jacinto7/esd/tidl-tools/11_01_06_00/TIDL_TOOLS/AM62A/tidl_tools.tar.gz